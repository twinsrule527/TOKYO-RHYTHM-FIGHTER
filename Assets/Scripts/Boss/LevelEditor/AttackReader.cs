...
public class AttackReader : MonoBehaviour
{
    ...
    [SerializeField] TextAsset [] stage0, stage1, stage2; //add more stages if needed 
    TextAsset [][] patternsText;

    void Awake() {
        patternsText[0] = stage0;
        patternsText[1] = stage1;
        patternsText[2] = stage2;
    }
